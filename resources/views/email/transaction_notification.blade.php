                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white content-cell">
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="padding: 0 2.5em; text-align: center;">
                                        <div class="text">
                                            ...
                                            <p>
                                                {{-- Please be informed that we deduct VAT 7.5% and a transaction fee 1.63% on applicable transactions. --}}
                                                There was a transaction on your account with the following details
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="text-author" style="min-width: 300px;">
                                            <h3 >
                                                Hi,
                                                {{$userName??'_USERNAME_'}}
                                            </h3>
                                            ...
                                            <p style="text-align: left;">
                                                SMS Credit: ₦{{ $credit??'-' }}
                                                {{-- Admin Message: {{ $adminMessage??'-' }}<br/> --}}
                                            </p>
                                            <p>
                                                <a href="https://smsurway.com.ng/" class="btn btn-primary">Login & Send SMS</a>
                                            </p>
                                        </div>
                                    </td>
                                </tr>
