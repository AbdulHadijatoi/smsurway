...
function skinChanger() {
	$('.choose-skin li').on('click', function() {
	    ...
	    var darkLogo = "../assets/images/logo.jpg";
	    var lightLogo = "../assets/images/logo.jpg";
...
function CustomJs() {
	...
	$(window).on('load resize', function() {
		if($(window).innerWidth() < 420) {
			$('.navbar-brand logo.svg').attr('src', '../assets/images/logo.jpg');
		} else {
			$('.navbar-brand logo.jpg').attr('src', '../assets/images/logo.svg');
		}
	});
